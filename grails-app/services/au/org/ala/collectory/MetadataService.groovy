...
class MetadataService {
    ...
    def getConnectionProfile(profileName) {
        log.error("showConnectionParameters: 2.1" + profileName)
        checkConnectionMetadata()
        log.error("showConnectionParameters: 2.2" + profileName)
        ...
        log.error("showConnectionParameters: 2.3")
        ...
        log.error("showConnectionParameters: 2.4") 
        clone
    }
    ...
    private checkConnectionMetadata() {
        log.error("checkConnectionMetadata" + connectionProfileMetadata)
