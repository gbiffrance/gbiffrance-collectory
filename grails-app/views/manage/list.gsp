...
<html>
    <head>
        ...
        <r:require modules="smoothness, collectory, jquery_ui_custom, alf" />
    </head>
    
    <body>
      <div class="content">

        <h1 id="admin-header"><g:message code="manage.list.title01" /></h1>
               ...
               %{--  <div id="addCollection" class="hide infoSection">
                ...
                %{-- <cl:ifGranted role="ROLE_COLLECTION_ADMIN">
                  <div>
                    ...
                    <div>
                        <g:link controller="public" action="map"><button class="btn btn-xs public-site"><g:message code="manage.list.link01" /></button></g:link>
                    </div>

                    <h3 class="admin-h3"><g:message code="manage.list.collection" /></h3>
                    <div class="homeCell">
                    ...
                    <h3 class="admin-h3"><g:message code="manage.list.institution" /></h3>
                    <div class="homeCell">
                    ...
                    <h3 class="admin-h3"><g:message code="manage.list.metadata" /></h3>
                    <div class="homeCell">
                    ...
                    <h3 class="admin-h3"><g:message code="manage.list.donnees" /></h3>
                    <div class="homeCell">
                    ...
                    <h3 class="admin-h3"><g:message code="manage.list.report" /></h3>
                    <div class="homeCell">
                    ...
                    <h3 class="admin-h3"><g:message code="manage.list.export" /></h3>
                    <div class="homeCell">
