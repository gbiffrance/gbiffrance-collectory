...
<body>
 <div class="container-fluid">
    ...
    <div class="col-md-9">
      ...
      <div class="dialog emulate-public">
        ...
        <div class="show-section well">
          ...
          <p id="first-section"><span class="category"><g:message code="collection.show.span.institution" /> : </span><g:link controller="institution" action="show" id="${instance.institution?.uid}">${instance.institution?.name}</g:link></p>
          ...
          <!-- last edit -->
          <p><span class="category">Dernière modification :</span> ${fieldValue(bean: instance, field: "userLastModified")} on ${fieldValue(bean: instance, field: "lastUpdated")}</p>
      ...
      <div class="show-section well">
        ...
        <!-- sub collections -->
        <h2 class="admin-h2"><g:message code="collection.show.title.subcollections" /></h2>
    ...
    <!-- collection scope -->
    <div class="show-section well">
      <h2 class="admin-h2"><g:message code="collection.show.title.gr" /></h2>
      <table>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value">
            <table id="bounds" class="table table-bordered">
      ...
      <h2 class="admin-h2"><g:message code="collection.show.title.tr" /></h2>
      <table>
        <colgroup><col width="25%"/><col width="75%"/></colgroup>
        <!-- Focus   -->
        <tr class="prop">
    ...
    <!-- Provider codes -->
    <div class="show-section well">
      <h2 class="admin-h2"><g:message code="collection.show.title.providercodes" /></h2>
