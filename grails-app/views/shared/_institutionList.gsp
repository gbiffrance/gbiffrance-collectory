...
<div class="list">
    <table class="table table-striped table-bordered">
      <colgroup>
        ...
        <thead>
            <tr>
                <g:sortableColumn property="name" title="${message(code: 'institution.name.label', default: 'Nom')}" />
                <g:sortableColumn property="acronym" title="${message(code: 'institution.acronym.label', default: 'Acronyme')}" />
                %{-- <g:if test="${showALAPartner == 'true'}">
