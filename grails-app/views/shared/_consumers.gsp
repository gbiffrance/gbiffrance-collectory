...
<div class="show-section  well">
  ...
  <div>
      <g:link class="edit-btn btn btn-sm" action='editConsumers' params="[source:'co']" id="${instance.uid}"><g:message code="shared.consumers.link01" />&nbsp;</g:link>
      <g:link class="edit-btn btn btn-sm" action='editConsumers' params="[source:'in']" id="${instance.uid}"><g:message code="shared.consumers.link02" /></g:link>
  </div>
</div>
