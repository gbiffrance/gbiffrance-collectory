        ...
        <div class="col-xs-6 col-md-4">
          ...
          <div class="section filter-buttons">
            <div class="all selected" id="all" onclick="toggleButton(this);return false;">
              <h2 id="first-filtre"><a href="" class="filtre-meta"><g:message code="public.map3.link.allcollections" /><span id="allButtonTotal"><g:message code="public.map3.link.showall" /> <collections></collections></span></a></h2>
            </div>
            <div class="plants" id="plants" onclick="toggleButton(this);return false;">
              <h2><a href="" class="filtre-meta"><g:message code="public.map3.link.plants" /><span style=""><g:message code="public.map3.link.vascular" />.</span></a></h2>
            </div>
            <div class="fauna" id="fauna" onclick="toggleButton(this);return false;">
              <h2><a href="" class="filtre-meta"><g:message code="public.map3.link.fauna" /><span style=""><g:message code="public.map3.link.mammals" />.</span></a></h2>
            </div>
            <div class="fungis" id="fungis" onclick="toggleButton(this);return false;">
              <h2><a href="" class="filtre-meta"><g:message code="public.map3.link.fungus" /><span style=""><g:message code="public.map3.link.fungi" />.</span></a></h2>
            </div>
           %{--  <div class="insects" id="entomology" onclick="toggleButton(this);return false;">
            ...
            <div class="microbes" id="microbes" onclick="toggleButton(this);return false;">
              <h2><a href="" class="filtre-meta"><g:message code="public.map3.link.mos" /><span style=""><g:message code="public.map3.link.protists" />.</span></a></h2>
            </div>
            <div class="paleontology" id="paleontology" onclick="toggleButton(this);return false;">
              <h2><a href="" class="filtre-meta"><g:message code="public.map3.link.paleontology" /><span style=""><g:message code="public.map3.link.paleontologies" />.</span></a></h2>
            </div>
          </div><!--close section-->
        ...
        <div class="col-xs-12 col-md-8" id="map-list-col">
            ...
            <div class="tab-content">
              ...
              <div  class="map-column">
                <div class="section">
                  <p id="#metadata-p"><g:message code="public.map3.maplistcol.des01" />.</p>
