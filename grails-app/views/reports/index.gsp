...
<html>
    ...
    <body>
        <h1 id="admin-header"><g:message code="reports.index.title01" /></h1>
        <div class="col-md-3 col-lg-3">
            ...
            <div id="SidebarBoxZ">
                <h2 class="stat-report"><g:message code="reports.index.title03" /></h2>
                <div>
        ...
        <div class="col-md-9">
            ...
            <cl:ifGranted role="${ProviderGroup.ROLE_ADMIN}"> <div class="dashboard"></div>

            <h2 class="admin-h2"><g:message code="reports.index.title04" /></h2>
            <div>
            ...
            <div class="dashCell">
                <h2 class="admin-h2"><g:message code="reports.index.title05" /></h2>
                 <div>
            ...
            <div class="dashCell">
                <h2 class="admin-h2"><g:message code="reports.index.title06" /></h2>
            ...
            <div class="dashCell">
                <h2 class="admin-h2"><g:message code="reports.index.title07" /></h2>
                <div style="clear:both;">
            ...
            <div class="dashCell">
                <h2 class="admin-h2"><g:message code="reports.index.title08" /></h2>
                <div style="clear:both;">
